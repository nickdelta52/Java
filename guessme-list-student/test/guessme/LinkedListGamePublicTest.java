...
public class LinkedListGamePublicTest {
	...
	public void testUpdateGuess2() {
		...
		assertEquals("gamerA third guess", 3222, gamerA.getGuess());
		assertTrue("gamerA third update", gamerA.updateGuess(0));
		
		assertEquals("gamerA second guess", 4333, gamerA.getGuess());
		assertTrue("gamerA second update", gamerA.updateGuess(0));
		
		assertEquals("gamerA third guess", 5444, gamerA.getGuess());
		assertTrue("gamerA third update", gamerA.updateGuess(0));
		
		assertEquals("gamerA second guess", 6555, gamerA.getGuess());
		assertTrue("gamerA second update", gamerA.updateGuess(0));
		
		assertEquals("gamerA third guess", 7666, gamerA.getGuess());
		assertTrue("gamerA third update", gamerA.updateGuess(0));
		
		assertEquals("gamerA second guess", 8777, gamerA.getGuess());
		assertTrue("gamerA second update", gamerA.updateGuess(0));
		
		assertEquals("gamerA third guess", 9888, gamerA.getGuess());
		assertTrue("gamerA third update", gamerA.updateGuess(1));
		
		assertEquals("gamerA third guess", 9999, gamerA.getGuess());
		assertTrue("gamerA third update", gamerA.updateGuess(4));
