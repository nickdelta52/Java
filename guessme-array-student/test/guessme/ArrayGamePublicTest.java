...
public class ArrayGamePublicTest {
	...
	public void testNumGuesses() {
		gamerB.reset();
		assertEquals("number of guesses should be 0", 0, gamerB.numGuesses());
		assertEquals("number of guesses should be 0", 0, gamerB.numGuesses());
		gamerB.getGuess();
		assertEquals("number of guesses should be 1", 1, gamerB.numGuesses());
		assertEquals("number of guesses should be 1", 1, gamerB.numGuesses());
		gamerB.updateGuess(0);
		gamerB.getGuess();
		assertEquals("number of guesses should be 2", 2, gamerB.numGuesses());
		assertEquals("number of guesses should be 2", 2, gamerB.numGuesses());
		gamerB.updateGuess(4);
		gamerB.getGuess();		
		assertEquals("number of guesses should be 3", 3, gamerB.numGuesses());
		assertEquals("number of guesses should be 3", 3, gamerB.numGuesses());
	}
